...
class control_node
{
    private:
        ...
        ros::Subscriber state_sub_; // 6wheel_skid_ctrl_cmd 토픽 받기
        ros::Publisher control_pub_; // simulation으로 publish
        ros::Publisher mode_pub_; // simulation으로 publish
    ...
    public:
        ...
        void callBack_4(const morai_msgs::SkidSteer6wUGVCtrlCmdPtr& msg);
